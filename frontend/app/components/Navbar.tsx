              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${
                    pathname === item.path
                      ? 'border-blue-500 text-gray-900 dark:text-white dark:border-dark-primary'
          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${
                pathname === item.path
                  ? 'bg-blue-50 dark:bg-gray-800 border-blue-500 dark:border-dark-primary text-blue-700 dark:text-white'
